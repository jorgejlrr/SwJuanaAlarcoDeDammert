...
<div class="row mt-4">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{url('docente/'.$trab->trab_id)}}" method="POST" class="form-horizontal" onsubmit="return Comprobar();"> 
                @method('PATCH')
                {{ csrf_field() }}
                    @if (count($errors)>0)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <input class="form-control" id="" min="1900-01-01" max="2002-12-31" type="date" name="trab_fnac" value="{{$trab->trab_fnac}}" required>
                        </div>
